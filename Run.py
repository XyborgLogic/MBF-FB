        ...
        for nama in name.split(' '):
            if len(name) <= 5:
                if len(nama) < 3:
                    ...
                    self.password.append(nama + '01')
                    self.password.append(sayang + '123')
                    self.password.append(sayang)
                    self.password.append(keluarga)
                    self.password.append(kontol + '123')
                    self.password.append(kontol + '12345')
                    self.password.append(kontol)
                    self.password.append(nama + '02')
            else:
                if len(nama) < 3:
