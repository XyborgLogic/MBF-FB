...
[bold white]Hasil Crack[bold red] Cp[bold white] Tersimpan Di :[bold red] Results/Cp.txt""", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Results Crack) [bold green]<[bold yellow]<[bold red]"))
    ...
    def realme_useragent(self, total):
        for _ in range(total):
            ...
            self.android_model = random.choice(['SM-S911B', 'ASUS_I005DA', 'LG-D802TR', 'Nokia 5 V', 'Redmi 01A', 'GT-I9060M', 'E2303', 'GT-H8570', 'Redmi Note 9 Pro Max'])
            self.useragent = ('Dalvik/1.6.0 (Linux; Android {}; {}) Build/SKQ1.211019.001; wv) AppleWebKit/AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/21.0 Chrome/{} Mobile Safari/537.36 [FB_IAB/Orca-Android;FBAV/402.0.0.11.101;]'.format(self.android_version, self.android_model, self.build, self.browser_version))
